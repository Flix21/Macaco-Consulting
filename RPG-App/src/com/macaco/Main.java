...
public class Main
{
    ...
    private static void choosePath(int intentos)
    {
        ...
        {
            case CASTILLO:
                enemy  = Arrays.asList("LOS PACHACHOS", "CABALLERO HUECO", "FANTASMA", "ESQUELETO");
                ...
                break;
            case BOSQUE:
                enemy  = Arrays.asList("GOBLIN", "LOS PACHACHOS", "FANTASMA", "LICÁNTROPO");
                ...
                break;
            case CUEVA:
                enemy  = Arrays.asList("GOBLIN", "LOS PACHACHOS", "OSO SALVAJE", "ESQUELETO");
    ...
    private static void showForest()
    {
        System.out.print("                                            .__ ._       \\_.\n");
        System.out.print("                                     _, _.  '  \\/   \\.-  /\n");
        System.out.print("                                      \\/     .-_`   // |/     \\,\n");
